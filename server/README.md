[Server side remake with typescript.](https://github.com/bartstc/comfy-offers-ts-server/tree/master)

# Comfy Offers

Fullstack project written in React and Express. The application is used to search for offer offers and to book them after creating an account. The logged in user has access to the management panel of his orders. You can also create a special account to add and manage your own offers.
...
```
git clone git@github.com:bartstc/comfy-offers-booking-app.git
```
...
[Comfy Offers App](https://morning-wave-69516.herokuapp.com/)
